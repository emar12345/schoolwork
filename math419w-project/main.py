...
# many lines
# APBs
create_avg_acf_plot(y_APB1_coords, "APB1 Y direction original", img_orig, 'y')
create_avg_acf_plot(y_APB1_coords, "APB1 Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_APB1_coords, "APB1 X direction original", img_orig, 'x')
create_avg_acf_plot(x_APB1_coords, "APB1 X direction denoised", img_blurred, 'x')
create_avg_acf_plot(y_APB2_coords, "APB2 Y direction original", img_orig, 'y')
create_avg_acf_plot(y_APB2_coords, "APB2 Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_APB2_coords, "APB2 X direction original", img_orig, 'x')
create_avg_acf_plot(x_APB2_coords, "APB2 X direction denoised", img_blurred, 'x')
# Nucleus
create_avg_acf_plot(y_nucleus_coords, "Nucleus Y direction original", img_orig, 'y')
create_avg_acf_plot(y_nucleus_coords, "Nucleus Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_nucleus_coords, "Nucleus X direction original", img_orig, 'x')
create_avg_acf_plot(x_nucleus_coords, "Nucleus X direction denoised", img_blurred, 'x')
# Cytoplasm
create_avg_acf_plot(y_cytoplasm_coords, "Cytoplasm Y direction original", img_orig, 'y')
create_avg_acf_plot(y_cytoplasm_coords, "Cytoplasm Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_cytoplasm_coords, "Cytoplasm X direction original", img_orig, 'x')
create_avg_acf_plot(x_cytoplasm_coords, "Cytoplasm X direction denoised", img_blurred, 'x')
# Background
create_avg_acf_plot(y_background_coords, "Background Y direction original", img_orig, 'y')
create_avg_acf_plot(y_background_coords, "Background Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_background_coords, "Background X direction original", img_orig, 'x')
create_avg_acf_plot(x_background_coords, "Background X direction denoised", img_blurred, 'x')
# Vacuoles
create_avg_acf_plot(y_vacuole1_coords, "Vacuole1 Y direction original", img_orig, 'y')
create_avg_acf_plot(y_vacuole1_coords, "Vacuole1 Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_vacuole_coords, "Vacuole1 X direction original", img_orig, 'x')
create_avg_acf_plot(x_vacuole_coords, "Vacuole1 X direction denoised", img_blurred, 'x')
create_avg_acf_plot(y_vacuole2_coords, "Vacuole2 Y direction original", img_orig, 'y')
create_avg_acf_plot(y_vacuole2_coords, "Vacuole2 Y direction denoised", img_blurred, 'y')

# correlation of known uncorrelated objects. Cross sections
create_avg_acf_plot(y_cross_coords, "Image Y direction original", img_orig, 'y')
create_avg_acf_plot(y_cross_coords, "Image Y direction denoised", img_blurred, 'y')
create_avg_acf_plot(x_cross_coords, "Image X direction original", img_orig, 'x')
create_avg_acf_plot(x_cross_coords, "Image X direction denoised", img_blurred, 'x')
